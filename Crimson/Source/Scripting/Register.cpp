...
namespace Crimson {
   ...
   void RegisterVector(asIScriptEngine* engine, const std::string& asTypename) {
	...
	void RegisterScript(asIScriptEngine* engine) {
		...
		r = engine->RegisterGlobalProperty("const int JOYSTICK_1", &SCRIPT_JOYSTICK_1); assert(r >= 0);
		r = engine->RegisterGlobalProperty("const int JOYSTICK_2", &SCRIPT_JOYSTICK_2); assert(r >= 0);
		r = engine->RegisterGlobalProperty("const int JOYSTICK_3", &SCRIPT_JOYSTICK_3); assert(r >= 0);
		r = engine->RegisterGlobalProperty("const int JOYSTICK_4", &SCRIPT_JOYSTICK_4); assert(r >= 0);
		r = engine->RegisterGlobalProperty("const int JOYSTICK_5", &SCRIPT_JOYSTICK_5); assert(r >= 0);
		r = engine->RegisterGlobalProperty("const int JOYSTICK_6", &SCRIPT_JOYSTICK_6); assert(r >= 0);
		r = engine->RegisterGlobalProperty("const int JOYSTICK_7", &SCRIPT_JOYSTICK_7); assert(r >= 0);
		r = engine->RegisterGlobalProperty("const int JOYSTICK_8", &SCRIPT_JOYSTICK_8); assert(r >= 0);
		r = engine->RegisterGlobalProperty("const int JOYSTICK_9", &SCRIPT_JOYSTICK_9); assert(r >= 0);
		r = engine->RegisterGlobalProperty("const int JOYSTICK_10", &SCRIPT_JOYSTICK_10); assert(r >= 0);
		r = engine->RegisterGlobalProperty("const int JOYSTICK_11", &SCRIPT_JOYSTICK_11); assert(r >= 0);
		r = engine->RegisterGlobalProperty("const int JOYSTICK_12", &SCRIPT_JOYSTICK_12); assert(r >= 0);
		r = engine->RegisterGlobalProperty("const int JOYSTICK_13", &SCRIPT_JOYSTICK_13); assert(r >= 0);
		r = engine->RegisterGlobalProperty("const int JOYSTICK_14", &SCRIPT_JOYSTICK_14); assert(r >= 0);
		r = engine->RegisterGlobalProperty("const int JOYSTICK_15", &SCRIPT_JOYSTICK_15); assert(r >= 0);
		r = engine->RegisterGlobalProperty("const int JOYSTICK_16", &SCRIPT_JOYSTICK_16); assert(r >= 0);
		r = engine->RegisterGlobalProperty("const int GAMEPAD_BUTTON_A", &SCRIPT_GAMEPAD_BUTTON_A); assert(r >= 0);
		r = engine->RegisterGlobalProperty("const int GAMEPAD_BUTTON_B", &SCRIPT_GAMEPAD_BUTTON_B); assert(r >= 0);
		r = engine->RegisterGlobalProperty("const int GAMEPAD_BUTTON_X", &SCRIPT_GAMEPAD_BUTTON_X); assert(r >= 0);
		r = engine->RegisterGlobalProperty("const int GAMEPAD_BUTTON_Y", &SCRIPT_GAMEPAD_BUTTON_Y); assert(r >= 0);
		r = engine->RegisterGlobalProperty("const int GAMEPAD_BUTTON_LEFT_BUMPER", &SCRIPT_GAMEPAD_BUTTON_LEFT_BUMPER); assert(r >= 0);
		r = engine->RegisterGlobalProperty("const int GAMEPAD_BUTTON_RIGHT_BUMPER", &SCRIPT_GAMEPAD_BUTTON_RIGHT_BUMPER); assert(r >= 0);
		r = engine->RegisterGlobalProperty("const int GAMEPAD_BUTTON_BACK", &SCRIPT_GAMEPAD_BUTTON_BACK); assert(r >= 0);
		r = engine->RegisterGlobalProperty("const int GAMEPAD_BUTTON_START", &SCRIPT_GAMEPAD_BUTTON_START); assert(r >= 0);
		r = engine->RegisterGlobalProperty("const int GAMEPAD_BUTTON_GUIDE", &SCRIPT_GAMEPAD_BUTTON_GUIDE); assert(r >= 0);
		r = engine->RegisterGlobalProperty("const int GAMEPAD_BUTTON_LEFT_THUMB", &SCRIPT_GAMEPAD_BUTTON_LEFT_THUMB); assert(r >= 0);
		r = engine->RegisterGlobalProperty("const int GAMEPAD_BUTTON_RIGHT_THUMB", &SCRIPT_GAMEPAD_BUTTON_RIGHT_THUMB); assert(r >= 0);
		r = engine->RegisterGlobalProperty("const int GAMEPAD_BUTTON_DPAD_UP", &SCRIPT_GAMEPAD_BUTTON_DPAD_UP); assert(r >= 0);
		r = engine->RegisterGlobalProperty("const int GAMEPAD_BUTTON_DPAD_RIGHT", &SCRIPT_GAMEPAD_BUTTON_DPAD_RIGHT); assert(r >= 0);
		r = engine->RegisterGlobalProperty("const int GAMEPAD_BUTTON_DPAD_DOWN", &SCRIPT_GAMEPAD_BUTTON_DPAD_DOWN); assert(r >= 0);
		r = engine->RegisterGlobalProperty("const int GAMEPAD_BUTTON_DPAD_LEFT", &SCRIPT_GAMEPAD_BUTTON_DPAD_LEFT); assert(r >= 0);
		r = engine->RegisterGlobalProperty("const int GAMEPAD_BUTTON_LAST", &SCRIPT_GAMEPAD_BUTTON_LAST); assert(r >= 0);
		r = engine->RegisterGlobalProperty("const int GAMEPAD_BUTTON_CROSS", &SCRIPT_GAMEPAD_BUTTON_CROSS); assert(r >= 0);
		r = engine->RegisterGlobalProperty("const int GAMEPAD_BUTTON_CIRCLE", &SCRIPT_GAMEPAD_BUTTON_CIRCLE); assert(r >= 0);
		r = engine->RegisterGlobalProperty("const int GAMEPAD_BUTTON_SQUARE", &SCRIPT_GAMEPAD_BUTTON_SQUARE); assert(r >= 0);
		r = engine->RegisterGlobalProperty("const int GAMEPAD_BUTTON_TRIANGLE", &SCRIPT_GAMEPAD_BUTTON_TRIANGLE); assert(r >= 0);
		r = engine->RegisterGlobalProperty("const int GAMEPAD_AXIS_LEFT_X", &SCRIPT_GAMEPAD_AXIS_LEFT_X); assert(r >= 0);
		r = engine->RegisterGlobalProperty("const int GAMEPAD_AXIS_LEFT_Y", &SCRIPT_GAMEPAD_AXIS_LEFT_Y); assert(r >= 0);
		r = engine->RegisterGlobalProperty("const int GAMEPAD_AXIS_RIGHT_X", &SCRIPT_GAMEPAD_AXIS_RIGHT_X); assert(r >= 0);
		r = engine->RegisterGlobalProperty("const int GAMEPAD_AXIS_RIGHT_Y", &SCRIPT_GAMEPAD_AXIS_RIGHT_Y); assert(r >= 0);
		r = engine->RegisterGlobalProperty("const int GAMEPAD_AXIS_LEFT_TRIGGER", &SCRIPT_GAMEPAD_AXIS_LEFT_TRIGGER); assert(r >= 0);
		r = engine->RegisterGlobalProperty("const int GAMEPAD_AXIS_RIGHT_TRIGGER", &SCRIPT_GAMEPAD_AXIS_RIGHT_TRIGGER); assert(r >= 0);
		r = engine->RegisterGlobalProperty("const int GAMEPAD_AXIS_LAST", &SCRIPT_GAMEPAD_AXIS_LAST); assert(r >= 0);
