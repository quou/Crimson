...
namespace Crimson {
   ...
   static glm::mat4 GetModelFromTransform(const Transform& transform) {
      ...
      glm::mat4 rotxMatrix = glm::rotate(glm::mat4(1.0f), glm::radians(rot.x), glm::vec3(1,0,0));
      glm::mat4 rotyMatrix = glm::rotate(glm::mat4(1.0f), glm::radians(rot.y), glm::vec3(0,1,0));
      glm::mat4 rotzMatrix = glm::rotate(glm::mat4(1.0f), glm::radians(rot.z), glm::vec3(0,0,1));
