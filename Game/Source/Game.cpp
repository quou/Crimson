...
private:
	void OnInit() override {
		...
		monkey.AddComponent<Crimson::PhysicsComponent>(new Crimson::Rigidbody(m_scene->GetPhysicsScene(), glm::vec3(0, 4, 0), glm::vec3(0, 0, 0))).rigidbody->AddBoxCollider(glm::vec3(1));
